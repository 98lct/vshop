        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="form-group">
                    <form method="post" action="{{route('AddAdverts')}}" enctype="multipart/form-data">
                    @csrf  
                    <label for="ipt_to_slug">Tên Adverts(Name)</label>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" name="url" class="form-control" placeholder="admin/Adverts/create" value="{{old('url')}}">
                    </div>
                </div>
                <div class="form-group">
